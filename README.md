...
SuntinCerl ProcGuard is a self-contained, real-time behavioral EDR engine for Windows 10 and Windows 11. Built under SynthicSoft Labs’ SuntinCerl Security Framework, the system provides rapid autonomous detection and mitigation of malicious processes using hybrid machine-learning style scoring combined with advanced heuristics.
...
SynthicSoft Labs develops autonomous cyber-defense technologies emphasizing local inference, zero-cloud dependence, and real-time response. Our mission is to deliver accessible, transparent, and effective security tooling engineered for modern threats.

Website:
[https://synthicsoftlabs.com](https://synthicsoftlabs.com)

GitHub:
[https://github.com/SynthicsoftLabs](https://github.com/SynthicsoftLabs)
